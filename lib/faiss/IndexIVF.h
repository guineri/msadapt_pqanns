...
struct IndexIVF: Index, Level1Quantizer {
	...
	void search_preassigned_parallel (idx_t n, const float *x, idx_t k,
                                     const idx_t *assign,
                                     const float *centroid_dis,
                                     float *distances, idx_t *labels,
                                     bool store_pairs, long cmprob,
	...
	void search_with_centroids (idx_t n, const float *x, idx_t k, 
				 idx_t *cidx, float* cdist, float *distances, idx_t *labels,
				 long cmprob,
				 std::vector<RWLock *> &bucketRwLock,
				 bool toBlock) const;
